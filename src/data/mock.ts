...
export const orders: Order[] = [
  {
    ...
    rawText: undefined,
    rawPreview:
      "https://images.unsplash.com/photo-1610375461369-d613b564f4c4?w=900&auto=format",
    totalValue: 406600,
  ...
  },
  {
    ...
    customer: {
      ...
      phone: "081-334-5566",
      address:
        "คอนโด 98 Wireless ห้อง 2504 ถ.วิทยุ แขวงลุมพินี เขตปทุมวัน กทม. 10330",
  ...
  },
  {
    ...
    customer: {
      ...
      phone: "094-778-1234",
      address:
        "99/123 คอนโด The Reserve ถ.สุขุมวิท 61 แขวงคลองตันเหนือ เขตวัฒนา กทม.",
  ...
  },
  {
    ...
    customer: {
      ...
      phone: "084-223-9911",
      address:
        "88/14 ม.3 ต.สันผักหวาน อ.หางดง จ.เชียงใหม่ 50230",
  ...
  },
  {
    ...
    customer: {
      ...
      phone: "089-556-7712",
      address:
        "45/2 ถ.ศรีภูวนารถ ต.หาดใหญ่ อ.หาดใหญ่ จ.สงขลา 90110",
